{**
 * templates/frontend/objects/schema_json_ld.tpl.tpl
 *
    ...
    <script type="application/ld+json">
        {
            ...
            "@graph": [
                {
                    "@type" : "Organization",
                    "@id": "https://www.psychopen.eu",
                    "name": "PsychOpen",
                    "logo": {
                        "@type": "ImageObject",
                        "name": "PsychOpenLogo",
                        "url": "https://leibniz-psychology.org/fileadmin/user_upload/logos/397x54_Produktnavigation_PsychOpen.png"
                    },
                    "url": "https://www.psychopen.eu",
                    "sameAs": "https://twitter.com/PsychOpen",
                    "memberOf" : {
                        "@type" : "Organization",
                        "@id": "https://www.leibniz-psychology.org/",
                        "url": "https://www.leibniz-psychology.org/",
                        "name": "Leibniz Institute for Psychology Information",
                        "logo": {
                            "@type": "ImageObject",
                            "name": "ZPIDLogo",
                            "url": "https://leibniz-psychology.org/fileadmin/docs/img/leibniz_psychology.svg"
                        },
                        "address":{
                            "@type" : "PostalAddress",
                        ...
                        "email" : "info@leibniz-psychology.org",
                        "faxNumber": "+49 (0)651 201-2071",
        ...
        {/if}
                        {
                                ...
                                "breadcrumb": "Home > Archives > Volume {$issue->getVolume()}({$issue->getNumber()}) > {$article->getLocalizedTitle($article->getLocale())|strip_tags:false|escape|strip|truncate:110}",
                                "isPartOf": {
                                    "@type" : "Website",
                                    "@id": "{$indexURI[0]}",
                                    "url": "{$indexURI[0]}",
