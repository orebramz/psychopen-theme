 ...
 * @todo The search filter component needs a pretty heavy rewrite along with the search.tpl page template. This template includes far too much logic which could be processed in SearchHandler.inc.php.
 *
